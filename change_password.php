  ...
  <div class="col-sm-8">
    <form action="" method="post" enctype="multipart/form-data">
          <table class="table table-bordered table-hover">
            <tr align="center">
              <td colspan="6" class="active"><h2>Zmień hasło</h2></td>
            </tr>
            
            <tr>
              <td style="font-weight: bold;">Obecne hasło</td>
              <td>
              <input class="form-control" type="password" name="current_pass" id="mypass" required="required" placeholder="Obecne hasło" />
              </td>
            </tr>
            ...
            <tr>
              <td style="font-weight: bold;">Potwierdź nowe hasło</td>
              <td>
              <input class="form-control" type="password" name="u_pass2" id="mypass" required="required" placeholder="Potwierdź nowe hasło" />
              </td>
            </tr>

            <tr align="center">
              <td colspan="6">
              <input class="btn btn-info" style="width: 250px;" type="submit" name="change" value="Zapisz"/>
              </td>
            </tr>
          </table>
        </form>

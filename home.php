			...
			<div class="col-md-3 col-sm-3 col-xs-12 left-sidebar">
				<div class="input-group searchbox">
					<div class="input-group-btn">
						<center><a href="include/find_friends.php"><button class="btn btn-default search-icon" name="search_user" type="submit">Ustawienia/Szukaj</button></a></center>
					</div>
				</div>
				<div class="left-chat">
					<ul>
			...
			<div class="col-md-9 col-sm-9 col-xs-12 right-sidebar">
					...
					<div class="col-md-12 right-header">
						...
						<div class="right-header-detail">
							<form method="post">
								...
								<span><?php echo $total; ?> wiadomości</span>&nbsp &nbsp
								<button name="logout" class="btn btn-danger">Wyloguj</button>
							</form>
							<?php
				...
				<div class="row">
					<div class="col-md-12 right-chat-textbox">
						<form method="post">
						<input autocomplete="off" type="text" name="msg_content" placeholder="Napisz wiadomość...">
